...
:global(div.produits div.tab-content ul){
    align-items: center;
    border-bottom-style: solid;
}
:global(div.produits div.tab-content ul li) {
    width: 50%;
}
:global(div.produits div.tab-content ul li a){
...
:global(div.produits div.tab-content ul li a.active){
